			...
			<div className="mx-auto w-full max-w-screen-md p-12">
				...
				<div className=" bg-white mt-11 items-baseline ju">
					{current < steps.length - 1 && (
						<button
							className="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-3.5 py-2.5 text-center me-2 mb-2"
							onClick={() => {
								if (isDisabled) {
									messageApi.open({
										type: "error",
