						...
						>
							...
							<div>
								...
								<Input.Password
									...
									className={`border border-gray-300 peer text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 w-full p-2.5  dark:border-gray-300 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500 font-medium flex flex-row ${error.passErr && "peer-invalid:outline-red-500"}`}
									onChange={onChange}
									onBlur={(event) => {
							...
							<div>
								...
								<Input.Password
									...
									name="confPass"
									placeholder="••••••••"
									className="border flex flex-row border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 w-full p-2.5  dark:border-gray-300 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500 font-medium"
									onChange={onChange}
